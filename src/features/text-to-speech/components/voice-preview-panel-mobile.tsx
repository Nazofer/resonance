...
interface VoicePreviewMobileVoice {
  id?: string
  name: string
}
...
export function VoicePreviewMobile({
  ...
  return (
    <div className="border-t p-4 lg:hidden">
      {/* Hidden player driven by custom controls; the transcript is shown on screen below. */}
      ...
      <div className="grid grid-cols-[1fr_auto] items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="icon" onClick={() => { downloadAudio(audioUrl, text); }}>
